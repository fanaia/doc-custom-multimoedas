...
function ConfiguracoesPage(){
  ...
  {tab==="emails"&&<section style={{...card,borderColor:"#7dd3fc",background:"linear-gradient(135deg,#f0f9ff,#fff)"}}>
    <h2 style={{margin:"0 0 5px"}}>E-mails Internos</h2><p style={{margin:"0 0 12px",color:"#475569"}}>Estes endereços serão incluídos automaticamente em <strong>Cc</strong> em toda fatura enviada ao cliente.</p>
